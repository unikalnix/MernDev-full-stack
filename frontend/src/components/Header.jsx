...
const Header = () => {
  ...
  const scrollToSection = (id) => {
    ...
    window.scrollTo({ behavior: "smooth", top: distanceFromTop });
  };
  return (
    <div ref={ref} className="relative w-full min-h-screen overflow-hidden">
          ...
          <div className="flex flex-col items-start w-full md:w-1/2">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-5">
              <button
                ...
                className="cursor-pointer relative px-6 py-2.5 rounded-3xl text-white text-[14px] font-semibold overflow-hidden border-2 border-transparent z-10  w-full sm:w-auto"
              >
              ...
              className="cursor-pointer px-6 py-2.5 rounded-3xl flex items-center justify-center gap-2 bg-[#242325] text-[14px] font-semibold hover:bg-[#3C3B3D] transition-all duration-200  z-50 w-full sm:w-auto">
      ...
      <div className="flex items-center justify-center">
        <button
          ...
          className="cursor-pointer outline-none border-none  group text-[14px] text-[#a1a1aa] hover:text-[#f67655] transition-all duration-200 flex flex-col justify-center items-center"
        >
